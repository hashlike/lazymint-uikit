...
import { CertikLogo, CertikCheck } from "./../../components/Svg";
  ...
  return (
    <Wrapper>
      <SCertik>
        <SCertik2>
          <div>Audited by</div>
          <CertikLogo width={100} height={24} style={{ width: "100px", height: "24px" }} />
          <CertikCheck width={20} height={20} style={{ width: "20px", height: "20px" }} />
        </SCertik2>
      </SCertik>
