...
var GradientButton = function (_a) {
    ...
    var internalProps = external ? getExternalLinkProps() : {};
    var isDisabled = disabled;
    return (React__default['default'].createElement(GradientStyledButton, __assign({}, internalProps, props, { disabled: isDisabled }),
        React__default['default'].isValidElement(startIcon) &&
            React__default['default'].cloneElement(startIcon, {
                mr: "0.5rem",
            }),
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 20 20" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { id: "linear-gradient", x1: "0.5", x2: "0.5", y2: "1", gradientUnits: "objectBoundingBox" },
                ...
                React__default['default'].createElement("stop", { offset: "1", "stop-color": "#21d4fd" }))),
        React__default['default'].createElement("path", { id: "check", d: "M3.736,12.619.161,9.044a.55.55,0,0,1,0-.778l.778-.778a.55.55,0,0,1,.778,0L4.125,9.9,9.283,4.738a.55.55,0,0,1,.778,0l.778.778a.55.55,0,0,1,0,.778L4.514,12.619a.55.55,0,0,1-.778,0Z", transform: "translate(0 -4.577)", fill: "url(#linear-gradient)" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "14px" }, isPushed ? (React__default['default'].createElement(Icon$O, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$N, { width: "24px", color: "textSubtle" }))),
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: cakePriceLink, target: "_blank" },
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
        ...
        } }, accountEllipsis)) : (React__default['default'].createElement(GradientButton, { size: "sm", onClick: function () {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(SCertik, null,
            React__default['default'].createElement(SCertik2, null,
                ...
                React__default['default'].createElement(Icon$J, { width: 100, height: 24, style: { width: "100px", height: "24px" } }),
                React__default['default'].createElement(Icon$K, { width: 20, height: 20, style: { width: "20px", height: "20px" } }))),
...
exports.CertikCheck = Icon$K;
exports.CertikLogo = Icon$J;
